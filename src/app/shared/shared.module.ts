...
@NgModule({
  ...
  exports: [CommonModule, IonicModule, TopCardComponent, PageFooterComponent, ReactiveFormsModule, MenuItemComponent, NoTaskComponent, RecurringComponent, SubTaskComponent, ExpandComponent],
