...
@NgModule({
  declarations: [MenuItemComponent, TopCardComponent, PageFooterComponent, NoTaskComponent, RecurringComponent,  ExpandComponent],
  imports: [CommonModule, IonicModule, FormsModule, ReactiveFormsModule],
  exports: [CommonModule, IonicModule, TopCardComponent, PageFooterComponent, ReactiveFormsModule, MenuItemComponent, NoTaskComponent, RecurringComponent,  ExpandComponent],
